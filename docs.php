...
<section id="introduction" class="mb-16">
    ...
    <p class="text-lg text-slate-600 leading-relaxed mb-6">Integrasi pembayaran multi-channel dengan <?= e($appName) ?>. Terima pembayaran QRIS, Virtual Account, GoPay, ShopeePay dari semua bank dan e-wallet Indonesia. Customer memilih metode langsung di halaman checkout branded Anda.</p>
...
<section id="create-transaction" class="mb-16">
    ...
    <div class="overflow-x-auto mb-6">
        <table class="w-full text-sm border border-slate-200 rounded-xl overflow-hidden">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="bg-indigo-50/50"><td class="px-4 py-3 font-mono text-indigo-600 text-xs break-all">payment_method</td><td class="px-4 py-3 text-slate-500">string</td><td class="px-4 py-3"><span class="text-slate-400 text-xs">No</span></td><td class="px-4 py-3 text-slate-600">Metode: <code>QRIS-A</code>, <code>BCAVA</code>, <code>BNIVA</code>, <code>GOPAY</code>, dll</td></tr>
    ...
    <div class="overflow-x-auto mb-6">
        <table class="w-full text-sm border border-slate-200 rounded-xl overflow-hidden">
            ...
            <tbody class="divide-y divide-slate-100">
                <tr><td class="px-4 py-3 font-mono text-blue-600 text-xs">QRIS-A</td><td class="px-4 py-3">QRIS</td><td class="px-4 py-3 text-slate-500 text-xs">QR Code scan semua bank & e-wallet</td></tr>
    ...
    <div class="bg-slate-50 border border-slate-200 rounded-xl p-4 mb-6">
        <p class="text-sm font-medium text-slate-700 mb-2">Alur Pembayaran:</p>
